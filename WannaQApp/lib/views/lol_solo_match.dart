...
class LolSoloMatch extends StatefulWidget {
  dynamic matches;
  List <String> urls;
  LolSoloMatch({
    Key? key,
  ...
  @override
  _LolSoloMatchState createState() => _LolSoloMatchState();
}
class _LolSoloMatchState extends State<LolSoloMatch> {
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index)  {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text("Rank: " + widget.matches[index]['ranksoloq'],
                        style: const TextStyle(color: Colors.white),),
                    );
                  },
                ),
